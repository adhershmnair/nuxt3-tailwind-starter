  ...
  <div class="homepage">
      ...
      <div class="hero-content text-center">
        <div class="max-w-xl">
          ...
          <p data-aos="fade-down" data-aos-delay="300" class="md:text-lg mb-6">
            Nuxt3 Tailwind Starter is a starter template project for Nuxt.js 3 +
            Tailwind CSS + Daisy UI with additional installed setup for custom
            font, icons, animation, and more.
          </p>
    ...
    <generic-container>
      <div class="flex flex-col">
        ...
        <p class="md:text-lg">
          Read
          <a
            href="https://github.com/adhershmnair/nuxt3-tailwind-starter#readme"
            class="text-primary"
            >the documentation</a
          >
    ...
    <generic-container>
      <div class="flex flex-col">
        ...
        <p class="md:text-lg">
          See what you can do below. Basically, every basic thing that you need
          is already included in this starter template project.
        </p>
      </div>
    </generic-container>
    ...
    <generic-container>
      <div class="flex flex-col mb-5">
        <h1 class="text-xl md:text-3xl mb-5">
          UI Components by Daisy UI 🌼 version 3
        </h1>
        <p class="md:text-lg">
          Learn more from the official
          <a class="text-primary" href="https://daisyui.com/" target="_blank"
            >daisyUI documentation</a
          >.
        </p>
      </div>
      <div class="flex flex-col">
    ...
    <generic-container>
      <div class="flex flex-col">
        ...
        <footer class="footer p-10 bg-base-200 text-base-content">
          <div>
            <span class="footer-title" href="/">Services</span>
