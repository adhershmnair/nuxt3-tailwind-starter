<template>
    ...
    <div class="hero min-h-screen bg-base-200">
      <div class="hero-content text-center">
        <div class="max-w-xl">
          <h1 data-aos="fade-down" class="text-4xl md:text-7xl font-bold mb-6">Nuxt3 Tailwind Starter</h1>
          <p data-aos="fade-down" data-aos-delay="300" class="md:text-lg mb-6">Nuxt3 Tailwind Starter is a starter template project for Nuxt.js 3 + Tailwind CSS + Daisy UI with additional installed setup for custom font, icons, animation, and more.</p>
          <div class="flex justify-center space-x-5">
            <a
              data-aos="fade-down"
              data-aos-delay="600"
              class="btn btn-sm md:btn-md btn-primary"
              href="https://github.com/adhershmnair/nuxt3-tailwind-starter/fork"
              target="_blank"
            >
              Fork this Project
            </a>
    ...
    <generic-container>
      <div class="flex flex-col">
        ...
        <p class="md:text-lg">Read <a href="https://github.com/adhershmnair/nuxt3-tailwind-starter#readme" class="text-primary">the documentation</a> on how to start quickly.</p>
      </div>
    </generic-container>
    ...
    <generic-container>
      <div class="flex flex-col">
        ...
        <p class="md:text-lg">See what you can do below. Basically, every basic thing that you need is already included in this starter template project.</p>
      </div>
    </generic-container>
      ...
      <div class="flex flex-col">
        ...
        <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
          <div class="items-center grid-flow-col">
            ...
            <p>Nuxt3 Starter Ltd. <br/>Providing reliable tech since 2023</p>
          </div>
  ...
  export default {
    ...
    setup () {
      ...
      useHead({
        ...
        description: 'Nuxt3 Tailwind Starter is a starter template for Nuxt.js 3 + Tailwind CSS + Daisy UI with additional installed setup for custom font, icons, and more.',
        link: [
